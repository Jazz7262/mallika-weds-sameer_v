          ...
          <div className="full-scrn-nav-content">
            ...
            <ul>
              <li className="list-item active">
                <a href="#header" className="link" onClick={handleNavToggle}>
                  Header
                </a>
              </li>
              <li className="list-item">
                <a href="#slide" className="link" onClick={handleNavToggle}>
                  Slide
                </a>
              </li>
              <li className="list-item">
                <a href="#couple" className="link" onClick={handleNavToggle}>
                  Couple
                </a>
              </li>
              <li className="list-item">
                <a href="#timeline" className="link" onClick={handleNavToggle}>
                  Event Date
                </a>
              </li>
              <li className="list-item">
